...
<head>
    ...
    <title>Product | ArasuvelRoofings</title>
    <meta name="description"
        content="Arasuvel Roofings is tensile roofings in Chennai. We Customized, roofings, Awnings, Retractable Awnings, Vertical Awnings, Aluminium Awnings in Chennai, PEB Structure in Chennai, Roofing Contractors in Chennai.">
    <meta name="keywords"
        content="tensile roofings in Chennai, aluminium awnings, residential terrace roofing Chennai, polycarbonate skylight roofings in Chennai, sandwich puffed roofing sheets in Chennai, tensile structures, roofing sheets, tensile membrane structure, parking sheds, roofing structure fabric manufacturer, Roofing contractors in chennai, Roofing Contractors nearby, Roofing contractors near me, Roofing company in chennai, Roofing companies in chennai, Roofing companies nearby, Roofing companies near me.">
    <meta name="news_keywords"
        content="tensile roofings in Chennai, aluminium awnings, residential terrace roofing Chennai, polycarbonate skylight roofings in Chennai, sandwich puffed roofing sheets in Chennai, tensile structures, roofing sheets, tensile membrane structure, parking sheds, roofing structure fabric manufacturer">
    <meta property="og:title" content="Tensile Roofings in Chennai | Aluminium Awnings in Chennai">
    <meta property="og:description"
        content="Arasuvel Roofings is tensile roofings in Chennai. We Customized, roofings, Awnings, Retractable Awnings, Vertical Awnings, Aluminium Awnings in Chennai.">
...
<body>
    ...
    <section id="about">
        <div class="p-3">
            <div class="container">
                <div class="breadcum">
                    <div class="p-3 text-center  bg-dark rounded rounded-4 text-bold">
                        <a href="{{route ('home')}}" class="text-bold">Home</a>/<a
